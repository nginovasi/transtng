...
<head>
    ...
    <link href="https://brtnusantara.com/transjateng/v2/assets/pages/sianteng/css/css-index.min.css" rel="stylesheet" nonce="HQVcmR4ER7m9vV7KPyuEPA">
    <script src="https://brtnusantara.com/transjateng/v2/assets/pages/sianteng/js/js-detect.min.js" nonce="HQVcmR4ER7m9vV7KPyuEPA"></script>
    <script src="https://brtnusantara.com/transjateng/v2/assets/pages/sianteng/js/picturefill-picturefill.min.js" nonce="HQVcmR4ER7m9vV7KPyuEPA"></script>
...
<div class="glue-header h-c-header h-c-header--corporate-initiative" xmlns:th="http://thymeleaf.org">
    <main id="jump-content" class="sc-main">
        <section class="sc-intro">
            <div class="h-c-page">
                ...
                <lottie-player src="https://assets4.lottiefiles.com/packages/lf20_0rpdkxjd.json"  background="transparent"  speed="1" style="width: 50%; height: 50%; margin: 0 auto;"  loop  autoplay></lottie-player>
                <h1 class="h-c-headline h-c-headline--one sc-intro__headline">
      <span role="text">Bagaimana kami dapat <span class="-no-break"> membantu Anda?</span>
</span>


                </h1>
                <div class="sc-intro__copy"> <span role="text"><p align="justify">Ada pertanyaan tentang Aplikasi TRANS TANGERANG? Kami merangkum pertanyaan seputar aplikasi TRANS TANGERANG dengan kategori pertanyaan dibawah ini.<span class="-no-break"> Silahkan cari informasi apa yang anda inginkan, Jika masih mengalami kesulitan silahkan hubungi kami melalui : <br> WA/ SMS  <b style="color: blue;">#</b> di <b style="color: black;" th:text="${contact}">"${contact}"<b>.</span>
            </p>
            </span>
                </div>
            </div>
            ...
            <lottie-player src="https://assets9.lottiefiles.com/packages/lf20_accg3lm5.json"  background="transparent"  speed="1"  style="width: 80%; height: 80%; margin: 0 auto;"  loop  autoplay></lottie-player>
            <br>
        </section>
                    ...
                    <div class="h-c-grid__col h-c-grid__col--12 h-c-grid__col-l--8 h-c-grid__col-l--offset-2">
                        <div data-glue-responsive-accordion-static data-glue-responsive-accordion-static-breakpoints="['x-small']" class="sc-principles">
                            <ol class="sc-principles__list">
                                ...
                                <li class="glue-a-zippy--v-smooth-expand sc-principles__panel" id="principle-">
                                    <h2 class="h-c-headline h-c-headline--four sc-principles__principle-header">


                                        <span role="text">. Pertanyaan Seputar <b>.</b></span>
  ...
  l3.8-3.8H3.5V8.3h8.4L8.1,4.5L9,3.5L14.5,9L9,14.5z"></path>
    ...
    <script src="https://brtnusantara.com/transjateng/v2/assets/pages/sianteng/js/lottie-lottie.js" nonce="HQVcmR4ER7m9vV7KPyuEPA"></script>
    <script src="https://brtnusantara.com/transjateng/v2/assets/pages/sianteng/js/1.6.6-angular.min.js" nonce="HQVcmR4ER7m9vV7KPyuEPA"></script>
    <script src="https://brtnusantara.com/transjateng/v2/assets/pages/sianteng/js/1.6.6-angular-animate.min.js" nonce="HQVcmR4ER7m9vV7KPyuEPA"></script>
    <script src="https://brtnusantara.com/transjateng/v2/assets/pages/sianteng/js/1.6.6-angular-touch.min.js" nonce="HQVcmR4ER7m9vV7KPyuEPA"></script>
    <script src="https://brtnusantara.com/transjateng/v2/assets/pages/sianteng/js/js-index.min.js" nonce="HQVcmR4ER7m9vV7KPyuEPA"></script>
</body>
