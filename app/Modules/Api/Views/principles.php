...
<head>
  ...
  <link href="<?=base_url()?>/assets/api/webview/css/css-index.min.css" rel="stylesheet" nonce="HQVcmR4ER7m9vV7KPyuEPA">
  <script src="<?=base_url()?>/assets/api/webview/js/js-detect.min.js" nonce="HQVcmR4ER7m9vV7KPyuEPA"></script>
  <script src="<?=base_url()?>/assets/api/webview/js/picturefill-picturefill.min.js" nonce="HQVcmR4ER7m9vV7KPyuEPA"></script>
...
<body>
                      ...
                      <li class="glue-a-zippy--v-smooth-expand sc-principles__panel" id="principle-1" data-glue-zippy-expand>
                        <h2 class="h-c-headline h-c-headline--four sc-principles__principle-header">
                                 ...
                                 <svg role="img" class="h-c-icon h-c-icon--chevron
                                    ...
                                    sc-principles__chevron">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#mi-chevron"></use>
                                 </svg>
                              </h2>
                              <div class="sc-principles__content">
                                 <div class="sc-principles__principle-copy">
                                    <p>
                                       <span role="text">Kami yakin bahwa ide-ide ini tidak terpisahkan. Ide-ide tersebut mewakili satu keyakinan inti yang telah memengaruhi semua produk yang kami buat sejak awal di Kementrian Perhubungan, dan produk yang akan kami buat ke depannya. Saat pengguna menggunakan produk kami, mereka mempercayakan informasinya kepada kami, dan sudah menjadi tugas kami untuk menjaganya. Ini berarti kami selalu bijaksana terkait data yang kami gunakan, cara menggunakan, dan <span class="-no-break">cara melindunginya.</span>
                                       </span>
                                    </p>
                                 </div>
                              </div>
                           ...
                           <li class="glue-a-zippy--v-smooth-expand sc-principles__panel" id="principle-3">
                              ...
                              <div class="sc-principles__content">
                                 <div class="sc-principles__principle-copy">
                                    <p>
                                       <span role="text">Kami menggunakan data agar Aplikasi Mitra Darat seperti Penelusuran dan Maps bermanfaat semaksimal mungkin. Kami juga menggunakan data untuk menayangkan lebih banyak iklan yang relevan. Meskipun iklan ini membantu mendanai layanan kami dan menjadikannya gratis bagi semua pengguna, namun sangat perlu ditekankan bahwa informasi pribadi pengguna kami <span class="-no-break">tidak dijual.</span>
                                       </span>
                                    </p>
                                 </div>
                              </div>
                           ...
                           <li class="glue-a-zippy--v-smooth-expand sc-principles__panel" id="principle-4">
                              ...
                              <div class="sc-principles__content">
                                 <div class="sc-principles__principle-copy">
                                    <p>
                                       <span role="text">Kami tahu tidak ada satu solusi yang cocok bagi semua pengguna dalam hal privasi. Setiap Aplikasi Mitra Darat dibuat dengan kontrol data aktif/nonaktif, sehingga pengguna kami dapat memilih setelan privasi yang tepat bagi mereka. Dan seiring berkembangnya teknologi, kontrol privasi kami juga berkembang, yang memastikan bahwa privasi selalu dikontrol <span class="-no-break">oleh pengguna.</span>
                                       </span>
                                    </p>
                                 </div>
                              </div>
                           ...
                           <li class="glue-a-zippy--v-smooth-expand sc-principles__panel" id="principle-5">
                              <h2 class="h-c-headline h-c-headline--four sc-principles__principle-header">
                                 <span role="text">5. Kami memberdayakan pengguna untuk meninjau, memindahkan, atau menghapus <span class="-no-break">data mereka.</span>
                                 </span>
                                 <svg role="img" class="h-c-icon h-c-icon--chevron
                                    h-c-icon--chevron-down
                                    sc-principles__chevron">
                              ...
                              <div class="sc-principles__content">
                                 <div class="sc-principles__principle-copy">
                                    <p>
                                       <span role="text">Kami percaya setiap pengguna harus memiliki akses ke informasi pribadi yang telah dibagikan kepada kami &ndash; kapan saja dan untuk alasan apa pun. Itulah alasan kami terus berupaya memudahkan pengguna untuk mengakses, meninjau, mendownload, serta memindahkan data ke layanan lain jika mereka menginginkannya, atau menghapus <span class="-no-break">data sepenuhnya.</span>
                                       </span>
                                    </p>
                                 </div>
                              </div>
                           ...
                           <li class="glue-a-zippy--v-smooth-expand sc-principles__panel" id="principle-6">
                              <h2 class="h-c-headline h-c-headline--four sc-principles__principle-header">
                                 <span role="text">6. Kami membuat teknologi keamanan terkuat ke dalam <span class="-no-break">produk kami.</span>
                                 </span>
                                 <svg role="img" class="h-c-icon h-c-icon--chevron
                                    h-c-icon--chevron-down
                                    sc-principles__chevron">
                              ...
                              <div class="sc-principles__content">
                                 <div class="sc-principles__principle-copy">
                                    <p>
                                       <span role="text">Menghormati privasi pengguna kami berarti melindungi data yang dipercayakan kepada kami. Agar semua produk dan Aplikasi Mitra Darat tetap aman, kami membangun dan menggunakan salah satu infrastruktur keamanan paling canggih di dunia. Ini berarti terus memperkuat teknologi keamanan internal kami guna mendeteksi dan melindungi terhadap ancaman online yang berkembang, sebelum ancaman tersebut menjangkau <span class="-no-break">pengguna kami.</span>
                                       </span>
                                    </p>
                                 </div>
                              </div>
  ...
  l3.8-3.8H3.5V8.3h8.4L8.1,4.5L9,3.5L14.5,9L9,14.5z"></path>
    ...
    <script src="<?=base_url()?>/assets/api/webview/js/lottie-lottie.js" nonce="HQVcmR4ER7m9vV7KPyuEPA"></script>
    <script src="<?=base_url()?>/assets/api/webview/js/1.6.6-angular.min.js" nonce="HQVcmR4ER7m9vV7KPyuEPA"></script>
    <script src="<?=base_url()?>/assets/api/webview/js/1.6.6-angular-animate.min.js" nonce="HQVcmR4ER7m9vV7KPyuEPA"></script>
    <script src="<?=base_url()?>/assets/api/webview/js/1.6.6-angular-touch.min.js" nonce="HQVcmR4ER7m9vV7KPyuEPA"></script>
    <script src="<?=base_url()?>/assets/api/webview/js/js-index.min.js" nonce="HQVcmR4ER7m9vV7KPyuEPA"></script>
</body>
