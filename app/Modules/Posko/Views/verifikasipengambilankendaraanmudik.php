                                    ...
                                    <form data-plugin="parsley" data-option="{}" id="form">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="form-group">
                                                <br />
                                                <label>Satus Check-In</label>
                                                <input type="text" class="form-control" id="motis_status_boarding" name="motis_status_boarding" autocomplete="off" placeholder="STATUS CHECK-IN" disabled>
                                                <br />
                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable" class="table table-theme table-row v-middle">
                                                <thead>
                                                    ...
                                                    <th><span>Status Pengambilan</span></th>
                ...
                function onScanSuccess(decodedText, decodedResult) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            Swal.close();
                            if (data.success) {
                                var motis_status_boarding = data.data.motis_status_boarding;
                                if (motis_status_boarding == 0) {
                                    motis_status_boarding = 'BELUM CHECK-IN';
                                ...
                                } else if (motis_status_boarding == 1) {
                                    motis_status_boarding = 'SUDAH CHECK-IN';
                                } else if (motis_status_boarding == 2) {
                                    motis_status_boarding = 'DITOLAK';
                                    $('#submit').attr('disabled', true);
                                    Swal.fire({
                                        icon: 'warning',
                                        title: 'Oops...',
                                ...
                                $('#motis_status_boarding').val(motis_status_boarding);
