                        ...
                        <div class="row mb-3">
                            <div class="col-lg-5 col-md-5 col-sm-12">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control form-control-md date" name="date-start" id="date-start" placeholder="Tanggal Penindakan Mulai" required autocomplete="off">
                                </div>
                            </div>
                            <div class="col-lg-5 col-md-5 col-sm-12">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control form-control-md date" name="date-end" id="date-end" placeholder="Tanggal Penindakan Selesai" required autocomplete="off">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table id="datatable" class="table table-theme table-row v-middle">
                                    <thead>
                                        <tr>
                                            <th><span>#</span></th>
                                            <th><span>Belangko</span></th>
                                            <th><span>Nama PPNS</span></th>
                                            <th><span>Satuan Kerja</span></th>
                                            <th><span>Nama Pelanggar</span></th>
                                            <th><span>Tanggal Penindakan</span></th>
                                            <th><span>Tanggal Sidang</span></th>
                                            <th><span>Tanggal Bayar</span></th>
...
<script type="text/javascript">
    ...
    function datatableColumn(){
        let columns = [
                ...
                {data: "belangko", orderable: false},
                {data: "nama_ppns", orderable: false},
                {data: "satuan_kerja", orderable: false},
                {data: "nama_pelanggar", orderable: false},
                {data: "tanggal_penindakan", orderable: false,
                    render: function(a, type, data, index) {
                        return data.tanggal_penindakan.split(' ')[0]
                    }
                },
                {data: "tanggal_sidang", orderable: false,
                    render: function(a, type, data, index) {
                        return data.tanggal_penindakan.split(' ')[0]
                    }
                },
                {data: "tanggal_bayar", orderable: false,
                    render: function(a, type, data, index) {
                        return data.tanggal_bayar != null ? data.tanggal_bayar : '<div class="text-center">-</div'
                    }
                },
                {
                    data: "id", orderable: false, width: 100,
                    render: function (a, type, data, index) {
                        ...
                        button += '<button class="btn btn-sm btn-outline-primary detail mr-2" data-id="'+data.id+'" data-toggle="tooltip" data-placement="top" title="Detail">\
