                            ...
                            <div class="table-responsive">
                                <table id="datatable" class="table table-theme table-row v-middle">
                                    <thead>
                                        <tr>
                                            <th><span>#</span></th>
                                            <th><span>Nama Provinsi</span></th>
                                            <th><span>Nama Kota</span></th>
                                            <th><span>Nama Jembatan</span></th>
                                            <th><span>Alamat</span></th>
                                            <th><span>Kode JT</span></th>
                                            <th><span>ETL Date</span></th>
...
<script type="text/javascript">
    ...
    function datatableColumn(){
        let columns = [
                ...
                {data: "nama_provinsi", orderable: false},
                {data: "nama_kota", orderable: false,
                    render: function(a, type, data, index) {
                ...
                {data: "kode_jt", orderable: false},
                {data: "etl_date", orderable: false,
                    render: function(a, type, data,index) {
                        return data.etl_date.split(' ')[0]
                    }    
                },
                {
                    data: "id", orderable: false, width: 100,
