                            ...
                            <div class="table-responsive">
                                <table id="datatable" class="table table-theme table-row v-middle">
                                    <thead>
                                        <tr>
                                            <th><span>#</span></th>
                                            <th><span>Nama Jembatan</span></th>
                                            <th><span>Tanggal</span></th>
                                            <th><span>Toleransi</span></th>
...
<script type="text/javascript">
    ...
    function datatableColumn(){
        let columns = [
                ...
                {data: "nama_jembatan", orderable: false},
                {data: "tanggal", orderable: false,
                    render: function(a, type, data, index) {
                        return data.nama_kota != null ? data.nama_kota : '<div class="text-center">-</div'
                    }
                },
                {data: "toleransi", orderable: false,
                    render: function(a, type, data, index) {
                        return data.toleransi != null ? data.toleransi : '<div class="text-center">-</div'
                    }
                },
                {data: "no_kend", orderable: false,
                    render: function(a, type, data, index) {
                        return data.no_kend != null ? data.no_kend : '<div class="text-center">-</div'
                    }
                },
                {data: "pelanggaran", orderable: false,
                    render: function(a, type, data, index) {
                        return data.pelanggaran != null ? data.pelanggaran : '<div class="text-center">-</div'
                    }
                },
                {
                    data: "id", orderable: false, width: 100,
                    render: function (a, type, data, index) {
                        ...
                        button += '<button class="btn btn-sm btn-outline-primary detail mr-2" data-id="'+data.id+'" data-toggle="tooltip" data-placement="top" title="Blue Lite">\
