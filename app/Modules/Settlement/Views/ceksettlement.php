        ...
        <div class="card">
            <div class="card-header">
                <ul class="nav nav-pills card-header-pills no-border" id="tab">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#tab-data" role="tab" aria-controls="tab-data" aria-selected="false">Cek File Settlement</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tab-form" role="tab" aria-controls="tab-form" aria-selected="false">Rekap File Settlement</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <!-- <label>Cek File Settlement Sampai</label> -->
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar mx-2">
                                                            ...
                                                            <input type="text" class="form-control form-control-md date" name="date-end" id="date-end" placeholder="Pilih Tanggal Akhir" required autocomplete="off">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="col-md-12">
                                                        ...
                                                        <select class=" custom-select select2" id="ceksettlement" name="ceksettlement" required></select>
                                                    </div>
                                                </div>
                                                <div class="col-md-1">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-md date" name="rekap-date-end" id="rekap-date-end" placeholder="Pilih Tanggal Akhir" required autocomplete="off">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="col-md-12">
                                                        <!-- <label>Pilih Bank</label> -->
                                                        <select class=" custom-select select2" id="rekapsettlement" name="rekapsettlement" required></select>
                                                    </div>
                                                </div>
                                                <div class="col-md-1">
                                                    <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#rekap-date-end').each(function() {}).on('changeDate', function() {
            dateParamEnd = $(this).val();
            console.log(dateParamEnd);
            coreEvents.filter = [$('#rekap-date-end').val()];
            $(this).datepicker('hide');
        });
        ...
        coreEvents.datepicker('#rekap-date-end', 'yyyy-mm-dd')
