                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control form-control-md date" name="date-start" id="date-start" placeholder="Pilih Tanggal" required autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <button class="btn w-sm mb-1 bg-success-lt">Lihat Rekap</button>
                                </div>
                            </div>
                        </div>
                    </div>
