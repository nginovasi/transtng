...
<body>
    ...
    <div class="row">
        <div class="dirjen">
            ...
            <br>
            No Rampcheck : <?=$data_excel->rampcheck_no?>
        </div>
        <div class="no-sticker">
            No Sticker : 
                <?php if($data_excel->rampcheck_sticker_no != null || $data_excel->rampcheck_sticker_no != ''){
                    echo $data_excel->rampcheck_sticker_no;
                } else {
                    echo '-';
                }?>
        </div>
    ...
    <div class="table-data">
        <table>
            ...
            <tr>
                ...
                <td style="width:25%">
                    <?=date("d M Y" , strtotime($data_excel->rampcheck_date))?>
                </td>
                <td style="width:5%; text-align:center;">6.</td>
                <td style="width:25%">Nama PO</td>
                <td><?=$data_excel->rampcheck_po_name?> 
                </td> 
            </tr>
            <tr>
                <td style="text-align:center;">2.</td>
                <td>Lokasi</td>
                <td><?=$data_excel->jenis_lokasi_name?></td>
                <td style="text-align:center;">7.</td>
                <td>Nomor Kendaraan</td>
                <td><?=$data_excel->rampcheck_noken?></td>
            </tr>
            <tr>
                <td style="text-align:center;">3.</td>
                <td>Nama Lokasi</td>
                <td><?=$data_excel->terminal_name?></td>
                <td style="text-align:center;">8.</td>
                <td>Nomor STUK</td>
                <td><?=$data_excel->rampcheck_stuk?></td>
            </tr>
            <tr>
                <td style="text-align:center;">4.</td>
                <td>Nama Pengemudi</td>
                <td><?=$data_excel->rampcheck_pengemudi?></td>
                <td style="text-align:center;">9.</td>
                <td>Jenis Angkutan</td>
                <td><?=$data_excel->jenis_angkutan_name?></td>
            </tr>
            <tr>
                <td style="text-align:center;">5.</td>
                <td>Umur</td>
                <td><?=$data_excel->rampcheck_umur_pengemudi?> Tahun</td>
                <td style="text-align:center;">10.</td>
                <td>Trayek</td>
                <td><?=$data_excel->trayek_name?></td>
            </tr>
        </table>
    </div>
    <br>
    ...
    <div class="table-administrasi">
        <table>
            <?php $arrAdministrasi = json_decode($data_excel->administrasi);
...
<!-- //////////////////////
    ...
    <div class="table-umum">
        <table class="table-umum">
            <?php $arrUtama = json_decode($data_excel->unsur_utama);
    ...
    <div class="table-penunjang">
        <table class="table-penunjang">
            <?php $arrPenunjang = json_decode($data_excel->unsur_penunjang);
...
<!-- //////////////////////
    ...
    <div class="table-kesimpulan">
        <table class="table-kesimpulan">
            <?php $arrKesimpulan = json_decode($data_excel->unsur_kesimpulan);
        ...
        <table class="table-ttd">
            ...
            <tr>
                <td style="text-align: center; height:100px; width: 30%">
                    <img src="<?=$dataKesimpulan->rampcheck_kesimpulan_ttd_pengemudi?>" alt="" srcset="">
                </td>
                <td style="text-align: center; height:100px; width: 30%">
                    <img src="<?=$dataKesimpulan->rampcheck_kesimpulan_ttd_penguji?>" alt="" srcset="">
                </td>
                <td style="text-align: center; height:100px; width: 30%">
                    <?php if($dataKesimpulan->rampcheck_kesimpulan_ttd_penyidik != null || $dataKesimpulan->rampcheck_kesimpulan_ttd_penyidik != ''){ ?>
                        <img src="<?=$dataKesimpulan->rampcheck_kesimpulan_ttd_penyidik?>" alt="" srcset="">
                    <?php } else {
                        echo '';
                    } ?>
                </td>
