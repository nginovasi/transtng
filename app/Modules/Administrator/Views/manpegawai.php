                        ...
                        <div class="tab-pane fade" id="tab-form" role="tabpanel" aria-labelledby="tab-form">
                            <form data-plugin="parsley" data-option="{}" id="form" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <input class="form-control" type="text" placeholder="Nama Lengkap" name="fullname" id="fullname" oninput="this.value = this.value.toUpperCase()" style="text-transform:uppercase" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        ...
                                        <span class="form-text text-muted"><small>Digunakan untuk login sistem.</small></span>
                                    </div>
                                </div>
                                <!-- <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            ...
                                            <span class="form-text text-muted"><small>Untuk reset password hubungi administrator.</small></span>
                                        </div>
                                    </div> -->
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <input class="form-control" type="email" placeholder="Email Aktif" name="email" id="email" oninput="this.value = this.value.toLowerCase()" style="text-transform:lowercase" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="noktp" class="col-2 col-form-label">No. KTP</label>
                                    <div class="col-4">
                                        <input class="form-control" type="number" placeholder="Nomor KTP" name="noktp" id="noktp" minlength="16" maxlength="16" required>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-4">
                                        <input type="text" class="form-control" placeholder="Kota Tempat Lahir" name="cob" id="cob" oninput="this.value = this.value.toUpperCase()" style="text-transform:uppercase" required>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <textarea class="form-control" name="addr" id="addr" placeholder="Alamat Pegawai" rows="3" oninput="this.value = this.value.toUpperCase()" style="text-transform:uppercase"></textarea>
                                    </div>
                                </div>
                                <!-- <div class="form-group row">
