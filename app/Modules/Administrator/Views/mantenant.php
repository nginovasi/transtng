                        ...
                        <div class="tab-pane fade" id="tab-form" role="tabpanel" aria-labelledby="tab-form">
                            <form data-plugin="parsley" data-option="{}" id="form" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-2">Nama Tenant</label>
                                    <div class="col-10">
                                        <input class="form-control" type="text" placeholder="Nama Tenant" id="name" name="name" autocomplete="off" required />
                                    </div>
                                </div>
                                <hr class="mt-3">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        coreEvents.insertHandler = {
            placeholder: 'Data tenant berhasil ditambahkan',
        ...
        coreEvents.deleteHandler = {
            placeholder: 'Data tenant berhasil dihapus',
