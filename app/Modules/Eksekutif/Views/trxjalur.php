...
<script type="text/javascript">
    ...
    const url_pdf = '<?= base_url() . "/" . uri_segment(0) . "/pdf/exportTrxPerJalurDateRangeJalurHalteBis" . "" ?>';
    ...
    $(document).ready(function() {
        ...
        $('#download-pdf').on('click', function(e) {
            let date = $('#date').val()
            let jalur = $('#jalur_id').val() ? $('#jalur_id').val() : ""
            let jenpos = $('#jenpos_id').val()
            let jalurText = $('#jalur_id').find(":selected").text()

            $(this).attr("href", url_pdf + '?date=' + date + '&jalur_id=' + jalur + '&jenpos_id=' + jenpos + '&jalur_text=' + jalurText);
    ...
    $('#btn-transaction').on('click', function() {
        ...
        $.ajax({
            method: "post",
            dataType : "json",
            url: url_ajax + "/getTrxPerJalurDateRangeJalurHalteBis",
            data:{
                <?= csrf_token() ?>: "<?= csrf_hash() ?>",
                "date": date,
                "jalur_id": jalur,
            ...
            success : function (rs) {
                ...
                if(rs.success){
                    ...
                    let title = `REKAP LAPORAN TRANSAKSI PER JENIS `
                    if(date) {
