        ...
        <div class="card">
            <div class="card-header">
                <ul class="nav nav-pills card-header-pills no-border" id="tab">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#tab-data" role="tab" aria-controls="tab-data" aria-selected="true"><i class="fa fa-id-card" aria-hidden="true"></i> Data Kartu BRT Baru</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
