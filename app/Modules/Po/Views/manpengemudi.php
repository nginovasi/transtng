                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control sel2" id="po_agent_id" name="po_agent_id"
                                                required>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="armada_name" name="armada_name"
                                                maxlength="300" required autocomplete="off"
                                                placeholder="Tentukan Nama Armada">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Kode Armada</label>
                                            <input type="text" class="form-control" id="armada_code" name="armada_code"
                                                maxlength="300" required autocomplete="off"
                                                placeholder="Tentukan Kode Armada Armada">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="armada_stnk_number"
                                                name="armada_stnk_number" maxlength="30" required autocomplete="off"
                                                placeholder="Tentukan Nomor STNK Armada">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Tanggal Berlaku STNK</label>
                                            <input type="date" class="form-control" id="armada_stnk_active_date"
                                                name="armada_stnk_active_date" required autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="armada_year"
                                                name="armada_year" maxlength="4" required autocomplete="off"
                                                placeholder="Tentukan Tahun Armada">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Nomor KIR</label>
                                            <input type="text" class="form-control" id="armada_kir_number"
                                                name="armada_kir_number" maxlength="30" required autocomplete="off"
                                                placeholder="Tentukan Nomor KIR Armada">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Tanggal Berlaku KIR</label>
                                            <input type="date" class="form-control" id="armada_kir_active_date"
                                                name="armada_kir_active_date" required autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="armada_plat_number"
                                                name="armada_plat_number" maxlength="300" required autocomplete="off"
                                                placeholder="Nomor Kendaraan Armada">
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>Warna Armada</label>
                                            <input type="color" class="form-control" id="armada_color"
                                                name="armada_color">
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="armada_merk" name="armada_merk"
                                                maxlength="300" autocomplete="off" placeholder="Tentukan Merk Armada">
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>GPS ID</label>
                                            <input type="number" class="form-control" id="armada_gps_id"
                                                name="armada_gps_id" maxlength="300" autocomplete="off"
                                                placeholder="Tentukan GPS ID">
                                        </div>
                                    </div>
                                </div>
