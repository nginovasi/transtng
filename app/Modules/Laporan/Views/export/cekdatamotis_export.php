...
<body>
	...
	<div class="table-data">
		<table>
			...
			<tfoot>
				<tr>
					<td colspan="13" style="text-align: center; font-size: 12px;">Dicetak pada <?= date('d-m-Y H:i:s') ?>, dengan user <?= session()->get('username') ?> dan IP <?= $_SERVER['REMOTE_ADDR'] ?></td>
				</tr>
			</tfoot>
		</table>
	</div>
