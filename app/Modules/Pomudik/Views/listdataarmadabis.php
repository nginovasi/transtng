                                ...
                                <table id="datatable" class="table table-theme table-row v-middle">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="column-2action">Total Kursi</th>
                                            <th class="column-2action">Total terbayar</th>
                                            <th><span></span></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" style="min-width: 230px;">Transaction Name</th>
                                            <th scope="col" style="min-width: 230px;">Transaction NIK</th>
                                        </tr>
                                    </thead>
                                    <tbody id="seats">
                                    </tbody>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        coreEvents.editHandler = {
            placeholder: '',
            afterAction: function(result) {
                var map_detail = JSON.parse(result.data.seat)
                ...
                $.each(map_detail, (k, v) => {
                    ...
                    $('#seats').append(`
                        <tr>
                            <td>
                                <input type="text" class="form-control" readonly name="seats[]" id="seats[]" autocomplete="off" value="${v.seat_map_detail_name ? v.seat_map_detail_name : '-'}">
                            </td>
                            <td>
                                <input type="text" class="form-control" readonly name="transaction_name[]" id="transaction_name[]" autocomplete="off" value="${v.transaction_name ? v.transaction_name : '-'}">
                            </td>
                            <td>
                                <input type="text" class="form-control" readonly name="transaction_nik[]" id="transaction_nik[]" autocomplete="off" value="${v.transaction_nik ? v.transaction_nik : '-'}">
                            </td>
                        </tr>
                    `)
                })
        ...
        let columns = [{
            ...
            },
            {
                ...
                render: function(a, type, data, index) {
                    ...
                    button += '<button class="btn btn-sm btn-outline-warning edit" data-id="'+data.id+'" title="Delete">\
                                    <i class="fa fa-edit"></i>\
                                </button></div>';
