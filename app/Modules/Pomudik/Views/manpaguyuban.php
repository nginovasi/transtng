                        ...
                        <div class="tab-pane fade" id="tab-form" role="tabpanel" aria-labelledby="tab-form">
                            <form data-plugin="parsley" data-option="{}" id="form">
                                ...
                                <div class="form-group">
                                    <label>Paguyuban Mudik</label>
                                    <input type="text" class="form-control" id="paguyuban_mudik_name" name="paguyuban_mudik_name" required autocomplete="off" placeholder="Tentukan Paguyuban">
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        coreEvents.insertHandler = {
            placeholder: 'Berhasil menyimpan data paguyuban',
        ...
        coreEvents.deleteHandler = {
            placeholder: 'Berhasil menghapus data paguyuban',
