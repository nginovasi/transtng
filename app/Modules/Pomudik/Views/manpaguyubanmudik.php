    ...
    $('#jadwal_mudik_id').change(function(){
        ...
        if(id == null) {
            ...
            $.ajax({
                ...
                success: function(rs){
                    if($('#paguyuban_mudik_id').val() && $("input[name='open']:checked").val() == 1 && rs[0].open == 0) {
                    ...
                    $.each(rs, (k, v) => {
                        if(v.billing_is_paguyuban == 0) {
                            disabled = `<td>
                                            ...
                                            <td>
                                                <select class="form-control sel2" readonly id="paguyuban_email${k}" name="paguyuban_email${k}">
                                                </select>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" readonly name="paguyuban_no_ktp[]" id="paguyuban_no_ktp${k}" autocomplete="off" value="${v.transaction_nik}">
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <select class="form-control sel2" readonly id="paguyuban_mudik_ids${k}" name="paguyuban_mudik_ids${k}">
                                                </select>
                                            </td>`
                        } else {
                            disabled = `<td>
